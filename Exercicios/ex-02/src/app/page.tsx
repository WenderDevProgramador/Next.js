  ...
  return (
    <article className={styles.post}>
      ...
      <div className={`${styles.postContent}`}>
        <Image src="/saturno.webp" alt="Saturno no espaço" width={600} height={307} />
        <p>
        ...
        <Image src="/aneis-de-saturno.webp" alt="Anéis de Saturno" width={600} height={328} />
        ...
        <Image src="/luas-de-saturno.jpg" alt="Luas de Saturno" width={600} height={315} />
      </div>
